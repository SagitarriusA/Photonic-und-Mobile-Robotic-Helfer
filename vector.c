...
3.0 18.12.2023 Kommentare hinzugefügt
*/
...
//-----Punkt-Gerade Abstand in 2D mit Normalvektorfunktion (Unterprogramm nötig für div. Rechnungen)-----
...
//-----Punkt-Gerade Abstand in 3D(Unterprogramm nötig für div. Rechnungen)-----
void distance3D(void)
{
	int n = 3;
